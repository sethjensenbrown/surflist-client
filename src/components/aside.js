...
export default function Aside() {
	return (
		<aside className="medium-2 columns hide-for-small">
            ...
            <iframe title="Amazon Ad - Candle " style={{width:120, height:240, marginWidth: 0, marginHeight: 0}} scrolling="no" frameBorder="0" src="//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=US&source=ac&ref=tf_til&ad_type=product_link&tracking_id=surfsites-20&marketplace=amazon&region=US&placement=B00BMT36EK&asins=B00BMT36EK&linkId=1da85547e7cd3b2c3060ebe8b5c60ba3&show_border=true&link_opens_in_new_window=true&price_color=333333&title_color=0066c0&bg_color=ffffff"></iframe>
